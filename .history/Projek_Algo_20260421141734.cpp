...
struct node_peminjamanBuku
{
    peminjamanBuku peminjaman;
    node_peminjamanBuku *next;
};
...
void peminjaman_buku()
{
    ...
    node_peminjamanBuku *head = NULL;
    node_peminjamanBuku *new_node;        // dekla var pointer
    new_node = new node_peminjamanBuku(); // membuat object struct peminjamanBuku di memo, lalu alamatnya akan disimpan di pointer new_node
