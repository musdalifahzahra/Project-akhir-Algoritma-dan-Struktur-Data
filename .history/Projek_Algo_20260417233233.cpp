...
void melihat_daftar_buku(dataBuku *ptr, int &jumlah)
{
    ...
    cout << left << setfill(' ') << setw(3) << "No." << " "
         ...
         << left << setfill(' ') << setw(15) << "judul_buku" << " "
         << left << setfill(' ') << setw(3) << "stok_buku" << " "
         << left << setfill(' ') << setw(3) << "Total Peminjaman" << " "
         << left << setfill(' ') << setw(3) << "Tersedia" << " "
    ...
    for (int i = 0; i < jumlahData; i++)
    {
        cout << left << setfill(' ') << setw(3) << i + 1 << " "
             ...
             << left << setfill(' ') << setw(3) << buku[i].total_peminjaman << " "
             << left << setfill(' ') << setw(3) << buku[i].tersedia << " "
