...
void pengembalian_buku()
{
    ...
    // 2. membaca file data_peminjaman.txt dan simpan data di linked list 
    ...
    // apabila sebelumnya dia tidak melakukan peminjaman
    if (!respon_pengembalian)
    {
        cout << "Anggota tidak melakukan peminjaman buku tersebut";
    }
    // apabila sebelumnya dia melakukan peminjaman
    else
    {
        ...
        // memperbarui data peminjaman di data_peminjaman.txt
