...
void cari_buku()
{
	...
	cout << "======= CARI DATA BUKU =======" << endl
		 << "Masukkan Judul dengan huruf kapital di awal setiap kata (contoh: Musdalifah Zahra Yhahaha)" << endl
		 << "Cari Buku: ";
	cin.ignore();
	getline(cin, cari);
	...
	{
		temp_benar = (ptr_d_lukisan + s)->pelukis;
		if (temp_benar == cari)
		{
			found = true;
		}
    ...
    else
	{
		cout << endl
			 ...
			 << "                          DAFTAR LUKISAN                           " << endl
			 << "===================================================================" << endl
			 << left << setfill(' ') << setw(3) << "No." << " "
			 << left << setfill(' ') << setw(27) << "Lukisan" << " "
			 << left << setfill(' ') << setw(27) << "Pelukis" << " "
			 << left << setfill(' ') << setw(5) << "Harga" << " " << endl
			 << "-------------------------------------------------------------------" << endl;

		int i = 1;
		for (int f = 0; f < n; f++)
		{
			string temp_cek = (ptr_d_lukisan + f)->pelukis;
			if (temp_benar == temp_cek)
			{
				cout << left << setfill(' ') << setw(3) << i << " "
					 << left << setfill(' ') << setw(27) << (ptr_d_lukisan + f)->lukisan << " "
					 << left << setfill(' ') << setw(27) << (ptr_d_lukisan + f)->pelukis << " "
					 << left << setfill(' ') << setw(5) << (ptr_d_lukisan + f)->harga << " " << endl;
				i++;
			}
		}
		cout << "===================================================================" << endl;
