...
struct linked_peminjaman_
{
    peminjamanBuku peminjaman;
    linked_peminjaman_ *next;
};
...
void peminjaman_buku()
{
    ...
    linked_peminjaman_ *head = NULL;
    linked_peminjaman_ *new_node;        // dekla var pointer
    new_node = new linked_peminjaman_(); // membuat object struct peminjamanBuku di memo, lalu alamatnya akan disimpan di pointer new_node
